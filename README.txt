...
Adiciona banners e um shortocde para criar um slider.

== Descrição ==

É adicionado um post type "banners" ao site, sendo cadastrável no painel administrativo. Ao criar um banner, é cadastrado
uma imagem para computador e outro para dispositivos móveis. E por meio do shortcode `[dft-banner]`, é possível adicionar em
qualquer local do site
...
= `apply_filters('dft_banners_desktop_height_size', $width)` =
...
= `apply_filters('dft_banners_mobile_height_size', $width)` =
